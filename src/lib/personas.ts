...
export const PRESET_PERSONAS: Persona[] = [
  { id: "early-adopter", name: "Early Adopter Tech", category: "simple", initials: "EA", avatarBg: "#EEFFC7", avatarColor: "#4D8605", avatarPhoto: "https://i.pravatar.cc/120?img=11", description: "Usuario técnico, tolera bugs, busca innovación. Evalúa si el concepto es potente aunque la ejecución sea rough.", traits: ["Tolerante con bugs", "Busca innovación", "Da feedback técnico", "Compara con alternativas"], frustration: "low", techLevel: "high" },
  { id: "busy-manager", name: "Manager Ocupado", category: "simple", initials: "MO", avatarBg: "#FFEBC6", avatarColor: "#E89E1B", avatarPhoto: "https://i.pravatar.cc/120?img=33", description: "Poco tiempo, necesita entender el valor en 10 segundos. Si no lo ve claro, abandona.", traits: ["Impaciente", "Orientado a resultados", "Delega tareas", "Busca ROI claro"], frustration: "high", techLevel: "medium" },
  { id: "skeptic", name: "Escéptico Pragmático", category: "simple", initials: "EP", avatarBg: "#DBEAFE", avatarColor: "#1447E6", avatarPhoto: "https://i.pravatar.cc/120?img=12", description: "Ha visto muchas herramientas fallar. Necesita pruebas concretas y casos de uso reales.", traits: ["Desconfiado", "Pide evidencia", "Compara precios", "Busca casos de éxito"], frustration: "medium", techLevel: "medium" },
  { id: "non-tech", name: "Usuario No Técnico", category: "simple", initials: "NT", avatarBg: "#FFE0E0", avatarColor: "#DC2625", avatarPhoto: "https://i.pravatar.cc/120?img=20", description: "No entiende jerga técnica. Si la UI no es obvia, se pierde. Representa al mainstream.", traits: ["Necesita guía visual", "Se frustra fácil", "No lee instrucciones", "Pregunta mucho"], frustration: "high", techLevel: "low" },
  { id: "power-user", name: "Power User", category: "simple", initials: "PU", avatarBg: "#DBFF95", avatarColor: "#4D8605", avatarPhoto: "https://i.pravatar.cc/120?img=5", description: "Usa el producto al máximo. Encuentra edge casos, quiere atajos y personalización.", traits: ["Explora todo", "Busca atajos", "Reporta bugs detallados", "Quiere API/integraciones"], frustration: "low", techLevel: "high" },
  { id: "switcher", name: "Switcher Insatisfecho", category: "simple", initials: "SI", avatarBg: "#F5F5EB", avatarColor: "#000000", avatarPhoto: "https://i.pravatar.cc/120?img=47", description: "Viene de usar un competidor y busca algo mejor. Compara cada detalle con lo que ya conoce.", traits: ["Compara con competencia", "Expectativas altas", "Busca migración fácil", "Sensible a regresiones"], frustration: "medium", techLevel: "high" },
  { id: "budget-owner", name: "Decisor de Compra", category: "simple", initials: "DC", avatarBg: "#FECACA", avatarColor: "#DC2625", avatarPhoto: "https://i.pravatar.cc/120?img=60", description: "Es quien aprueba el presupuesto. No usa el producto directamente pero necesita entender el valor.", traits: ["Evalúa coste-beneficio", "Pricing transparente", "Necesita justificar compra", "Poco tiempo"], frustration: "high", techLevel: "low" },
  { id: "mobile-first", name: "Mobile-First User", category: "simple", initials: "MF", avatarBg: "#DBEAFE", avatarColor: "#1447E6", avatarPhoto: "https://i.pravatar.cc/120?img=15", description: "Hace todo desde el móvil. Si la experiencia no es responsive, abandona.", traits: ["Solo usa móvil", "Sensible a rendimiento", "Gestos táctiles", "No tolera scroll horizontal"], frustration: "high", techLevel: "medium" },
